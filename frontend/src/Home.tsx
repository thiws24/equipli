...
function Home() {
    ...
    const colDefs: ColDef<InventoryItemProps, any>[] = [
        ...
        { field: "photoUrl", headerName: "Foto", flex: 1, minWidth: 150, cellRenderer: (params: any) => <img style={{ height: 40 }} src={`data:image/jpeg;base64,${params.data.photo}`} alt="Picture"/> },
